...
24. **[Output of ASIMP](audits/asimp-output.html):** Example execution output, report format, and baseline metrics generated by ASIMP.
25. **[Output of Lynis](audits/lynis-output.html):** High-fidelity example of the Lynis host auditing utility scanning logs, attributes, and suggestions.
26. **[Output of OpenSCAP](audits/openscap-output.html):** Detailed example of OpenSCAP CIS Level 2 scan evaluation rules, results, and generated remediations.
27. **[AWS Services vs. On-Premises Open-Source Stack Comparison](aws-vs-onprem-stack-comparison.html):** Detailed layer-by-layer architectural comparison across 12 layers mapping AWS services to self-hosted open-source counterparts.
